                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-2 text-sm text-gray-600">
                                    <p><i class="fas fa-calendar mr-2"></i><?= date('D, M j, Y', strtotime($booking['show_date'])) ?></p>
                                    <p><i class="fas fa-clock mr-2"></i><?= date('g:i A', strtotime($booking['show_time'])) ?></p>
                                    <p><i class="fas fa-user mr-2"></i><?= htmlspecialchars($booking['customer_name']) ?></p>
                                    <p><i class="fas fa-envelope mr-2"></i><?= htmlspecialchars($booking['customer_email']) ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-xl p-4 shadow-sm">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-purple-600"><?= htmlspecialchars($booking['seat_numbers']) ?></span>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl p-4 shadow-sm">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium"><?= $booking['num_tickets'] ?> × ₹<?= number_format($booking['total_amount'] / $booking['num_tickets']) ?></span>
                            </div>
                        </div>
                        ...
                        <div id="upiFields" class="hidden">
                            ...
                            <div class="text-center py-8">
                                ...
                                <div class="inline-block p-4 bg-gray-100 rounded-lg">
                                    <div class="w-32 h-32 bg-gradient-to-br from-purple-400 to-pink-400 rounded-lg flex items-center justify-center">
